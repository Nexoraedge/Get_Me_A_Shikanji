    ...
    return (
        <div className=' container mx-auto max-h-screen'>
            ...
            <h1 className='text-2xl text-center font-bold'>Login to get your fans to support you</h1>
                    ...
                    <button
                        className="flex items-center w-70  border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium  hover:bg-gray-200  blurkr blurkr  trainsition-all ease duration-500   blurkr focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                    ...
                    <button
                        className="flex items-center w-70  border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium  hover:bg-gray-200  blurkr trainsition-all ease duration-500  blurkr focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                        <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
